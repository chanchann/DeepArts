...
# @FilePath     : /app/deeparts/core/models/classifier/kerastuner/image_classifier.py
# @Desc         :
"""
...
from deeparts.core.preprocess.image.load import (
    read_classify_dataset_from_dir,
    write_tfrecords_to_target_path,
)
from deeparts.core.preprocess.image.process import (
...
import random
import os
from deeparts.core.preprocess.data.data_generator import ImageClassifierDataGnenrator


class deepartsKerasTunerImageClassifier:
    def __init__(
        self,
...
if __name__ == "__main__":
    deepartsKerasTunerImageClassifier(
